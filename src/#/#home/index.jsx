    ...
    <App className="scroll-white">
        ...
        <div className="container fcb | py-3">
          ...
          <nav>
            <ul className="fcb w-full">
              <li className="text-blue-700 | fc | mx-7 px-5 py-2 rounded-md | text-sm | cursor-pointer">
          ...
          <div className="fcc rounded-full | text-base font-bold text-blue-700">
            <h3>Kirish</h3>
      ...
      <App.Container>
        <section className="flex-col fc pt-20 | relative | space-y-10">
          <h1 className="text-5xl font-bold | text-gray-primary">O’rganing.</h1>
          <h1 className="text-5xl font-bold | text-gray-primary">
