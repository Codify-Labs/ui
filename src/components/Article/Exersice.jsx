...
`);
  ...
  return (
    <div className="exercise mb-7">
      {/* EXERCISE DROPDOWN */}
      <div className="dropdown | relative | flex items-center  py-2 mb-7 px-4 bg-[#20E100] rounded-[7px] | cursor-pointer">
        <div className="completed | bg-white p-1.5 rounded-[7px]">
          <svg
            className="w-4 h-4"
            viewBox="0 0 11 8"
            fill="none"
        ...
        <h1 className="pl-10 | text-[15px] text-white font-extrabold">
          Jadval yaratish
        </h1>
      ...
      <div className={`transition-all transform duration-500 overflow-hidden`}>
        ...
        <div className="result px-4 mt-16 rounded-[7px] bg-[#ffff0033] ">
          <div className="dropdown | relative | flex items-center  py-2 mb-5 rounded-[7px] |">
          ...
          <div
            className={`rounded-[7px] | duration-500 | relative ${
              true && "blur-sm cursor-pointer"
            }`}
            id="article"
          >
